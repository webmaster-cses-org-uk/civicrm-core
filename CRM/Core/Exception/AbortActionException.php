...
/**
 * Exception thrown when a hook wants to prevent a database action in the calling function.
 *
 ...
 */
class CRM_Core_Exception_AbortActionException extends \CRM_Core_Exception {
